...
export default function ExcelSolutionsApp() {
  ...
  const schedulingLink = "https://calendar.app.google/Rxm3noFkf92a2Qw9A";
  ...
  const text = {
    en: {
      ...
      heroSubtitle:
        "From custom VBA tools to implemented workflows, we help to transform your business to the 21st century.",
      ...
      servicesList: [
        {
          ...
          description:
            "Learn how to make Excel work for you, not the other way around",
          icon: <HeadphonesIcon />,
        },
        {
        ...
        },
        {
          ...
          description:
            "Get expert advice and support for all your business needs.",
          icon: <Sparkles />,
        },
        {
      ...
      benefitsList: [
        ...
        },
        {
          title: "Gain Insights",
          description:
            "Unlock the full potential of your data with advanced Excel solutions",
          icon: "💡",
        },
        {
          title: "Scale Operations",
          description:
            "Less administrative work means more time to grow your business",
          icon: "📈",
        },
      ],
      teamMembers: [
        {
          name: "Almog Dror",
          role: "Excel & Innovation Expert",
          image:
            "https://media.licdn.com/dms/image/v2/D4D03AQEX_J1EwNBLVQ/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1711562619187?e=1734566400&v=beta&t=duhfgTaJ-xkqZ9kz9MjXZ6GrCE2NEDzBsvNEUfG9_70",
        ...
        },
        {
          ...
          image:
            "https://media.licdn.com/dms/image/v2/D4D03AQExXkJA2OLf5g/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1665434051000?e=1734566400&v=beta&t=r4z0GnrtZ4aKDHD0cPXtdS4HzPXBxrionmswpAJ4lJE",
          linkedin: "https://www.linkedin.com/in/ori-dagan-856078251/",
          whatsApp: "https://wa.me/972543191601",
        },
        {
          name: "Yuval Chen",
          role: "Automation & Web Development Expert",
          image:
            "https://media.licdn.com/dms/image/v2/D5603AQEPvEOHQRDJBQ/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1700061564317?e=1734566400&v=beta&t=lrQQqLnEu84_RR45FpWZEsFx-J29ZvwzrC0chvntNqo",
        ...
        },
        {
          ...
          role: "Tax Expert",
          image:
            "https://media.licdn.com/dms/image/v2/C5603AQF8auC-AT_Dnw/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1639866425888?e=1735776000&v=beta&t=ijXrXsBrAPQjebIhNZpu5aTFg9zRw4pO7xNQESArfgQ",
      ...
      formTimeError:
        "You are not allowed to submit a message at this time. Please wait a minute and try again.",
      ...
      excelExamples: [
        {
          ...
          description:
            "This powerful combination is used for looking up values in a table or range. It's more flexible than VLOOKUP as it allows for both vertical and horizontal lookups even in 2 dimenstional arrays.",
        },
        {
          formula:
        ...
        },
        {
          ...
          description:
            "The Excel SUMPRODUCT function multiplies ranges or arrays together and returns the sum of products.",
        },
        {
    ...
    he: {
      ...
      heroSubtitle:
        "מפיתוח כלים מותאמים אישית ועד הטמעת תהליכי עבודה, נעזור לכם לייעל את העסק שלכם",
      ...
      servicesList: [
        {
          title: "הדרכות אקסל",
          description:
            "למדו כיצד לגרום לאקסל לעבוד בשבילכם, במקום שאתם תעבדו בשבילו",
          icon: <HeadphonesIcon />,
        },
        {
          title: "פיתוח אוטומציות",
          description:
            "קבלו פתרונות מותאמים אישית לתהליך העבודה שלכם וחסכו זמן יקר",
          icon: <Code />,
        },
        {
          title: "תמיכה טכנית וייעוץ",
          description: "ייעוץ עסקי ותמיכה טכנית בהטמעת תהליכים",
          icon: <Sparkles />,
        },
        {
          title: "טמפלייטים לאקסל",
          description: "ניצור לכם טמלייטים מותאמים אישית למשימות מורכבות",
          icon: <FileText />,
        },
      ],
      ...
      benefitsList: [
        {
          title: "חיסכון בזמן",
          description: "נבנה לכם אוטומציה עבור משימות טכניות מורכבות",
          icon: "⏱️",
        },
        {
          title: "הפחתת טעויות",
        ...
        },
        {
          ...
          description: "למדו כיצד לגרום לאקסל לעבוד בשבילכם",
          icon: "🚀",
        },
        {
          title: "הפקת תובנות",
          description: "נעזור לכם לפענח תובנות חשובות מהמידע העסקי שלכם",
          icon: "💡",
        },
        {
          title: "הרחבת הפעילות",
          description:
            "נעזור לפענח את התחומים הרווחים ביותר בפעילות העסקית שלכם",
          icon: "📈",
        },
      ],
      teamMembers: [
        ...
        {
          name: "יובל חן",
          role: " מומחה אוטומציות ופיתוח אתרים",
          image:
            "https://media.licdn.com/dms/image/v2/D5603AQEPvEOHQRDJBQ/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1700061564317?e=1734566400&v=beta&t=lrQQqLnEu84_RR45FpWZEsFx-J29ZvwzrC0chvntNqo",
          linkedin: "https://www.linkedin.com/in/yuval-chen/",
          whatsApp: "https://wa.me/972546830556",
      ...
      testimonial:
        '"גם לכם האקסל מראה ש1/2= הראשון לפברואר? הגיע הזמן להבין איך להשתמש באקסל"',
      ctaTitle: "מוכנים להצמיח את העסק שלכם בעזרת אקסל?",
      ctaText:
        " נוכל לעזור לכם לייעל את תהליכי העבודה באקסל ולהגביר את היעילות שלכם",
      ...
      formTimeError:
        "אינך מורשה לשלוח הודעה כרגע. אנא המתן דקה ולאחר מכן שלח שוב.",
      ...
      excelExamples: [
        {
          ...
          description:
            "במצבים בהם שימוש בפונקציית VLOOKUP לא עובד, ניתן להשתמש בשילוב הזה כדי למצוא מידע גם במערך דו מימדי",
        },
        {
          formula:
            "=SUMIFS(sum_range, criteria_range1, criteria1, [criteria_range2, criteria2, ...])",
          ...
          description:
            "מאפשר לסכום ערכים העומדים במספר קריטריונים. מצוין ליצירת דוחות דינמיים וניתוח נתונים על בסיס תנאים שונים.",
        },
        {
          formula:
            "=VLOOKUP(lookup_value, table_array, col_index_num, [range_lookup])",
          ...
          description:
            "משמש למציאת נתונים בטבלה או טווח לפי שורה. מושלם לאחזור מידע ממסדי נתונים גדולים על בסיס ערך חיפוש ספציפי.",
        },
        {
          formula: "=FILTER(array, include, [if_empty])",
          title: "FILTER לחילוץ נתונים דינמי",
          description:
            "מאפשרת לחלץ נתונים העומדים בקריטריונים ספציפיים. כלי חזק ליצירת דוחות דינמיים מבוססי קריטריונים.",
        },
        {
          formula:
            "=XLOOKUP(lookup_value, lookup_array, return_array, [if_not_found], [match_mode], [search_mode])",
          ...
          description:
            " XLOOKUP היא נוסחא חזקה יותר מ VLOOKUP מכיוון שהיא יכולה לחפש ערכים אנכית ואופקית בטווח המוגדר.",
        },
        {
          formula: "=SUMPRODUCT(array1,[array2],...)",
          title: "SUMPRODUCT לחישוב מהיר",
          description:
            "מאפשר לקחת שני מערכים/ טווחים או יותר, להכפיל את הערכים שבהם וסוכם את התוצאה.",
        },
        {
          formula: "=IFERROR(value, value_if_error)",
          title: "IFERROR לטיפול בשגיאות",
          description:
            "משמש ללכידת שגיאות בנוסחאות וטיפול בהן. שימושי לשמירה על גיליונות נקיים ומקצועיים על ידי הצגת הודעות מותאמות אישית במקום ערכי שגיאה.",
        },
        {
          formula: "=LET(name1, value1, name2, value2, ..., calculation)",
          title: "LET לשיום חלקים בנוסחה",
          description:
            " מאפשרת להקצות שמות לתוצאות חישוב. זה יכול להפוך נוסחאות מורכבות לקריאות יותר וקלות יותר לניפוי באגים.",
        },
      ],
    },
  };
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      await setDoc(
        ...
        { merge: true }
      ); // Merge to update fields instead of overwriting completely
