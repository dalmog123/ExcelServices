...
export default function ExcelSolutionsApp() {
  ...
  const text = {
    en: {
      ...
      team: 'Our Team',
      contact: 'Contact',
      heroTitle: 'Supercharge Your Business with Advanced Excel Solutions',
      ...
      benefitsList: [
        ...
        'Boost Productivity: Focus on what really matter at your business',
        'Gain Insights: Unlock the full potential of your data with our help',
        'Find new Clients: Optimze your client acquisition to grow faster',
      ],
      teamMembers: [
        { name: 'Almog Dror', role: 'Excel & Innovation Expert', image: '/placeholder.svg?height=400&width=400' },
        { name: 'Ori Dagan', role: 'Business Development Expert', image: '/placeholder.svg?height=400&width=400' },
        { name: 'Yuval Chen', role: 'Automation Development Expert', image: '/placeholder.svg?height=400&width=400' },
      ],
      ...
      ctaText: "Let's discuss how we can optimize your workflows and boost your business efficiency.",
    ...
    he: {
      ...
      servicesList: [
        { title: 'הדרכות אקסל', description: 'שפרו את הצוות שלכם עם הדרכות אקסל מקצועיות.', icon: <HeadphonesIcon /> },
        { title: 'פיתוח אוטומציות וכלים', description: 'פתרונות מותאמים אישית לאוטומציה וייעול תהליכי העבודה שלכם.', icon: <Code /> },
        { title: 'תמיכה טכנית וייעוץ', description: 'קבלו ייעוץ ותמיכה לכל צרכי העסק שלכם.', icon: <Sparkles /> },
        { title: 'טמפלייט לאקסל מותאם אישית', description: 'בניית טמפלייט מותאם אישית להגברת הפרודוקטיביות שלכם.', icon: <FileText /> },
      ],
      benefitsTitle: '?למה לבחור בשירותים שלנו',
      benefitsList: [
        'חיסכון בזמן: נבנה לכם אוטומציה של משימות טכניות לייעול תהליכי עבודה',
        'הפחתת טעויות: צמצמו טעויות אנוש בהזנת נתונים ידנית וחישובים מסורבלים',
        'הגברת פרודוקטיביות: התמקדו במה שחשוב באמת לעסק שלכם',
        'הפקת תובנות: מיצוי מלוא הפוטנציאל של הנתונים שלכם לקבלת החלטות חכמות',
        'הרחבת מאגר הלקוחות: נעזור לכם באסטרטגיית החדירה לשוק למציאת לקוחות חדשים',
      ],
      teamMembers: [
        { name: 'אלמוג דרור', role: 'מומחה אקסל וחדשנות', image: '/placeholder.svg?height=400&width=400' },
        { name: 'אורי דגן', role: 'מומחה פיתוח עסקי', image: '/placeholder.svg?height=400&width=400' },
        { name: 'יובל חן', role: 'מומחה לפיתוח אוטומציה', image: '/placeholder.svg?height=400&width=400' },
      ],
      ...
      ctaTitle: 'מוכנים להצמיח את העסק שלכם?',
